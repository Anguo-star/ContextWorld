# Cube Gripper Carry History=3 v4r1 Reference-Training v2 Protocol

Status: `preregistered_before_reference_training`. This v2 protocol authorizes a
...
## v1 infrastructure failure and v2 recovery
...
The freezer additionally preflights the exact `path` and `checkpoint` aliases consumed by the shared resolver and writes one x-exclusive receipt. The formal trainer refuses to run
...
- reusing or modifying the archived v1 output namespace.
