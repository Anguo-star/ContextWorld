...
Suite v2 候选配置中的九个能力不再分别维护公开说明，避免重复内容和版本漂移。每项能力
在正式文档中都使用“任务目标、数据构成、评测方法、基线表现、适用范围”五段统一结构；
Cube 成员资格仅由 canonical registration decision 激活。
...
| Cube 夹爪携带规则 | [6.9 Cube 夹爪携带规则](ContextWorld_ICL_Benchmark.md#69-cube-夹爪携带规则) | `configs/benchmark/cube_gripper_carry_h3_v4r1_icl_release_v1.yaml` | `contextworld-cube-gripper-carry` |
